...
class BlogImportDataBlogCategoryTemplate implements FromQuery, WithTitle, WithHeadings, WithEvents, ShouldAutoSize
{
    ...
    {
        return \App\Models\BlogCategory::query()->select('blog_categories.name as blog_category_name');
    }

...
class CityImportDataProvinceTemplate implements FromQuery, WithTitle, WithHeadings, WithEvents, ShouldAutoSize
{
    ...
    {
        return \App\Models\Province::query()->select('provinces.name as province_name');
    }

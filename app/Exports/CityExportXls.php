...
class CityExportXls implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents
{
    /**
    ...
    */
    ...
    {
        $filter = new CityFilter(new Request(self::$params));

...
class BlogExportXls implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents
{
    /**
    ...
    */
    ...
    {
        $filter = new BlogFilter(new Request(self::$params));
        return Blog::generateQuery($filter)->get();
    }

    public function headings(): array
    {
        return ['NAME', 'PROTOCOL', 'URL', 'BLOG CATEGORY ID', 'LANGUAGE ID'];
    }
